...
<div id="container">
	...
	<div id="wrapper">
		<div id="content" style="height: 210px;">
             ...
             <%
             ContenidoCurso contenido = 
             				(ContenidoCurso)request.getAttribute("contenido");
             %>
             <h3>Editar Tema</h3>
             <form action="<%=request.getContextPath() %>/EditarContenidoCursoServlet" method="post">
             <input type="hidden" value="editar" name="funcion" />
             <input type="hidden" value="<%=contenido.getIdContenidoCurso() %>" name="txt_id" />  
             Nombre: <input value="<%=contenido.getNombreTema() %>" type="text" name="txt_nombre" />
             <br /><br />
             <p> </p>
              Semana: <input value="<%=contenido.getSemana() %>" type="text" name="txt_semana" />
             <br /><br />
             <p> </p>
              Unidad: <input value="<%=contenido.getUnidad() %>" type="text" name="txt_unidad" />
             <br /><br />
             <p> </p>
             Link: <input value="<%=contenido.getLink() %>" type="text" name="txt_link" />
             <br /><br />
