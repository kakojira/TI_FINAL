...
<body>
<form name="form1" method="post" action="RegistroLibrosDocente">
  <table width="861" height="596" border="0" bgcolor="#000000">
    ...
    <tr>
      ...
      <td  height="365" colspan="2" bgcolor="#FFFFFF"><table width="520" border="0">
        <tr>
          <th height="48" colspan="2" class="style2" scope="col">Registro Libro </th>
          </tr>
        <tr>
          <td width="185" height="48" class="style2">Nuevo Libro : </td>
          <td width="319" class="style2"><label>
            <input name="txt_nuevoLibro" type="text" id="txt_nuevoLibro">
          </label></td>
        </tr>
        <tr>
          <td height="42" class="style2">Ingrese Link : </td>
          <td class="style2"><label>
            <input name="txt_link" type="text" id="txt_link">
          </label></td>
        </tr>
        <tr>
          <td height="37" class="style2">Ingrese una descripcion: </td>
          <td class="style2"><label>
            <textarea name="txa_descripcion" id="txa_descripcion"></textarea>
          </label></td>
        </tr>
        <tr>
          <td height="41" colspan="2" class="style2"><label>
            <div align="center">
              <input name="btn_libro" type="submit" class="style2" id="btn_libro" value="Agregar">
              </div>
          </label></td>
          </tr>
      </table></td>
